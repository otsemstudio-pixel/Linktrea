...
// encore rempli (Phase 4) — remplace l'ancien "0 ANS" + sparkline plate +
// trois messages "Aucun... pour le moment", qui ne montraient rien et
// décourageaient. Le profil de démonstration existant (demoProfile, déjà
// utilisé par le script seed) sert de contenu d'exemple, habillé du thème
// réellement choisi par l'utilisateur — pas un rendu générique déconnecté
// de ses choix de fond/accent/typographie.
export default function PublicEmptyProfileGhost({ theme }: Props) {
  const ghostProfile = { ...demoProfile, theme }
