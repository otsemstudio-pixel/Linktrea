...
export default function EclatVariantPicker({ value, onChange }: Props) {
  const { reduced } = useMotionPrefs()

  return (
    <div className="mt-3">
      <span className="text-label uppercase tracking-label text-muted block mb-2">Variante</span>
      <div className="grid grid-cols-3 gap-2">
        {ECLAT_VARIANT_IDS.map((variant) => {
          ...
          return (
            ...
            >
              <EclatBackgroundLayer variant={variant} active={!reduced} />
